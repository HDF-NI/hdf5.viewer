    ...
    for (var arrayIndex = 0; arrayIndex < array.length; arrayIndex++)
    {
        ...
        switch (childType)
        {
            case H5OType.H5O_TYPE_GROUP:
                ...
                var branch = await this.loadRecursiveGroup(tool);
...
H5Tree.prototype.loadRecursiveGroup = async function(group){
...
//                }
                ...
                if(child.getNumObjs()>0)
                {
                    jsonDoc+="\"type\" : \"group\",\n";
                    jsonDoc+="\"children\" : [\n";
                    jsonDoc+= await this.loadRecursiveGroup(child);
                    jsonDoc+="]\n,";
