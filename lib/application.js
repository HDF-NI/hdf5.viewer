...
app.use(route.post('/create_h5/:path', h5.createH5));
...
app.use(route.post('/make_image/:path', h5images.makeImage));
app.use(route.post('/make_dataset/:path', h5datasets.makeDataset));
app.use(route.post('/make_table/:path', h5tables.makeTable));
app.use(route.post('/modify_fields/:path', h5tables.modifyFields));
